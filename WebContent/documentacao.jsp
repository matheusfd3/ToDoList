...
<body>
	...
	<section class="container">
		...
		<h3><u>Descrição:</u></h3> 
		<p class="lead"> Um projeto simples WEB onde teremos um CRUD. Deve-se cadastrar uma tarefa e atribuir a <br>
		mesma para um usuário cadastrado. Não será necessário um CRUD para o usuário inicialmente. <br>
		Faça utilizando o mais simples, nada de ferramentas, apenas o básico.</p>
	
		<h3><u>Arquitetura:</u></h3>
		<p class="lead"> MVC Action Based, JSP, JSTL, CSS, JavaScript (pode usar o Jquery ou outro <br>
		framework para validação, data etc...).</p>
		...
		<p class="lead"><u>OBS:</u> A tarefa será apenas além do ID uma descrição do que é a tarefa e qual usuário ela <br>
		pertence. Não se pode adicionar tarefa sem que o usuário <b>esteja logado</b>.</p>
	</section>
